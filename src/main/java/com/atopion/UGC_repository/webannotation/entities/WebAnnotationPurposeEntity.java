...
@Entity
@Table(name = "web_annotation_purpose")
public class WebAnnotationPurposeEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
    @JsonIgnore
	@Column(name = "purpose_id", nullable = false, unique = true, columnDefinition = "int(10)")
	...
	protected WebAnnotationPurposeEntity() {}

	public WebAnnotationPurposeEntity(int purpose_id, String purpose, WebAnnotationBodyEntity bodyEntity, WebAnnotationTargetEntity targetEntity) {
	...
	public WebAnnotationPurposeEntity(String purpose, WebAnnotationBodyEntity bodyEntity, WebAnnotationTargetEntity targetEntity) {
		this.purpose = purpose;
		this.bodyEntity = bodyEntity;
		this.targetEntity = targetEntity;
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof WebAnnotationPurposeEntity)) return false;
		WebAnnotationPurposeEntity that = (WebAnnotationPurposeEntity) o;
		return Objects.equals(purpose_id, that.purpose_id) && Objects.equals(purpose, that.purpose) && Objects.equals(bodyEntity, that.bodyEntity) && Objects.equals(targetEntity, that.targetEntity);
	}

	@Override
	public int hashCode() {
		return Objects.hash(purpose_id, purpose, bodyEntity, targetEntity);
	}

	@Override
	public String toString() {
		return "WebAnnotationPurposeEntity{purpose_id=" + purpose_id + ", purpose='" + purpose + "', bodyEntity=" + bodyEntity + ", targetEntity=" + targetEntity + "}";
	}
}